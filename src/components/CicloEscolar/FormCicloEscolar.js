            ...
            <>
                <Row>
                    <Col xs="12" md="12" className="mb-2">
                        <Label htmlFor="colegio" className="mb-0">Seleccionar ciclo</Label>
                        <Select 
                            classNamePrefix="select2-selection"
                            placeholder={SELECT_OPTION}
                            options={ciclosNameOpt.map(item=>({value: item.id, label: item.nombre}))} 
                            value={cicloNameObj}
                            onChange={value=>setCicloNameObj(value)}                            
                        />
                    </Col>
                    <Col xs="12" md="12" className="mb-2">
                        <Button color="primary" type="button" onClick={()=>fillData(false)}>
                            Aceptar
                        </Button>
                    </Col>
                    <hr />
                    <Col xs="12" md="12">
                        <Button color="secondary" type="button" onClick={()=>fillData(true)}>
                            Crear nuevo ciclo
                        </Button>
                    </Col>
                </Row>
