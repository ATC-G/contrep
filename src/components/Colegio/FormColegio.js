...
export default function FormColegio({item, setItem, setReloadList}){
    ...
    return(
        ...
        >
            ...
            <Row>
                <Col xs="12" md="3">
                    <Label htmlFor="calle" className="mb-0">Calle</Label>
                    <Input
                        id="calle"
                        name="direccion.calle"
                        className={`form-control ${formik.errors.direccion?.calle ? 'is-invalid' : ''}`}
                        onChange={formik.handleChange}
                ...
                <Col xs="12" md="3">
                    ...
                    <Input
                        ...
                        className={`form-control ${formik.errors.direccion?.numero ? 'is-invalid' : ''}`}
                        onChange={formik.handleChange}
                ...
                <Col xs="12" md="3">
                    ...
                    <Input
                        ...
                        className={`form-control ${formik.errors.direccion?.codigoPostal ? 'is-invalid' : ''}`}
                        onChange={formik.handleChange}
            ...
            <Row>
                <Col xs="12" md="3">
                    ...
                    <Input
                        ...
                        className={`form-control ${formik.errors.direccion?.colonia ? 'is-invalid' : ''}`}
                        onChange={formik.handleChange}
                        value={formik.values.direccion.colonia}  
                    />
                </Col>
                <Col xs="12" md="3">
                    <Label htmlFor="municipioDelegacion" className="mb-0">Municipio</Label>
                    <Input
                        id="municipioDelegacion"
                        name="direccion.municipioDelegacion"
                        className={`form-control ${formik.errors.direccion?.municipioDelegacion ? 'is-invalid' : ''}`}
                        onChange={formik.handleChange}
                ...
                <Col xs="12" md="3">
                    ...
                    <Input
                        ...
                        className={`form-control ${formik.errors.direccion?.estado ? 'is-invalid' : ''}`}
                        onChange={formik.handleChange}
                        value={formik.values.direccion.estado}  
                    />
                </Col>
                <Col xs="12" md="3">
                    <Label htmlFor="pais" className="mb-0">País</Label>
                    <Input
                        id="pais"
                        name="direccion.pais"
                        className={`form-control ${formik.errors.direccion?.pais ? 'is-invalid' : ''}`}
                        onChange={formik.handleChange}
